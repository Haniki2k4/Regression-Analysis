...
## **II. Sự thay đổi của các vấn đề trong 20 năm (2000-2021)**
...
### **2. Kiểm định Giả thuyết về Nước sạch và Bệnh Tiêu chảy qua 20 năm**
...
ggplot(diarrhea_trends, aes(x = year, y = diarrhea_rate, color = water_status, group = water_status)) +
  ...
  labs(
    title = "Kiểm định giả thuyết về Nước sạch và Bệnh Tiêu chảy qua 20 năm (2000-2021)",
