...
ggplot(safe_tab, aes(x = "", y = n, fill = factor(safe_water))) +
  ...
  labs(title = "Tỉ lệ hộ sử dung nguồn nước an toàn tại Việt Nam năm 2021") +
  theme_void()
```

**Nhận xét:** Phần lớn các hộ gia đình (86.4%) có nguồn nước sử dụng an toàn.Tuy nhiên, vẫn còn 13.6% hộ chưa được tiếp cận nước sạch -\> nguy cơ cao gặp các vấn đề về sức khỏe, bệnh tật do nguồn nước ô nhiễm
...
**Nhận xét:** Khoảng 87.9% hộ có nhà tiêu hợp vệ sinh. Tuy nhiên còn 12.1% hộ chưa có công trình vệ sinh hợp chuẩn -\> có thể gây ô nhiễm môi trường và lây lan bệnh tật.
...
**Nhận xét:** Tỷ lệ hộ thành thị sử dụng nước sạch (96.9%) cao hơn rõ rệt so với nông thôn (81.6%) -\> thể hiện được sự chênh lệch hạ tầng cấp nước giữa hai khu vực
...
**Nhận xét:** Khu vực thành thị có điều kiện vệ sinh tốt hơn nhiều so với nông thôn. Tỷ lệ hộ có nhà tiêu hợp vệ sinh ở nông thôn thấp hơn 13.6 % so với thành thị,
...
**Nhận xét:** - p = 0.4051 \> 0.05 -\> Không có mối liên hệ thống kê có ý nghĩa giữa việc sử dụng nước sạch và tình trạng tiêu chảy ở trẻ em trong mẫu khảo sát này
...
**Nhận xét:** - Các yếu tố (windex5) và (helevel) có ảnh hưởng tích cực và có ý nghĩa thống kê rất cao đến khả năng có nhà tiêu hợp vệ sinh. - HH6 và HC2 có ý nghĩa thống kê -\> có thể làm giảm xác suất có điều kiện vệ sinh tốt
