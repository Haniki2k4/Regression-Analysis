...
**Nhận xét:** Phần lớn các hộ gia đình (96%) có nguồn nước sử dụng an toàn.Tuy nhiên, vẫn còn 4% hộ chưa được tiếp cận nước sạch -\> nguy cơ cao gặp các vấn đề về sức khỏe, bệnh tật do nguồn nước ô nhiễm
...
**Nhận xét:** Tỷ lệ hộ thành thị sử dụng nước sạch (99.5%) cao hơn rõ rệt so với nông thôn (94.4%) -\> thể hiện được sự chênh lệch hạ tầng cấp nước giữa hai khu vực
